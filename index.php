...
<body>
    ...
    ?>
    <p>Привет <?=$_COOKIE['user']?>. Чтобы выйти нажмите <a href="messenger.php">здесь</a>.</p>
    ...
    <div id="zatemnenie">
        <form id="okno" action="check.php" method="post">
            ...
            <div class="blockmail">
                <a href="#" class="mail" onmouseover="this.className='mail-active'" onmouseout="this.className='mail'">Использовать эл.почту</a>
            </div>
    ...
    <div id="zatemnenie2">
        <form id="okno" action="auth.php" method="post">  
            <div class="topreg">
                <a href="#" class="close">Закрыть</a>
                <img class="imgclass3" src="img/Twitter-Logo.png">
                <button class="send" type="submit">Далее</button>
